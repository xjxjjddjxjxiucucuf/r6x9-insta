...
+ (NSArray *)sections {
    return @[
        @{
            @"header": @"",
            @"rows": @[
                [SCISetting linkCellWithTitle:@"R6X9 Channel" subtitle:@"Join the R6X9 Telegram channel for updates" icon:[SCISymbol symbolWithName:@"paperplane.circle.fill" color:[UIColor systemBlueColor] size:20.0] url:@"https://t.me/STORR6X96"]
            ]
        },
        @{
            @"header": @"",
            @"rows": @[
                ...
                [SCISetting navigationCellWithTitle:@"Saving"
                                        ...
                                        @{
                                            @"header": @"Audio",
                                            @"rows": @[
                                                [SCISetting switchCellWithTitle:@"Ask to convert video to audio" subtitle:@"When downloading a reel/video, choose between saving the video or converting it to an audio file (.m4a)" defaultsKey:@"dw_audio_prompt"]
                                            ]
                                        },
                                        @{
            ...
            @"rows": @[
                ...
                [SCISetting navigationCellWithTitle:@"Debug"
                                        ...
                                        @{
                                            @"header": @"R6X9",
                                            @"rows": @[
                                                [SCISetting switchCellWithTitle:@"Enable tweak settings quick-access" subtitle:@"Allows you to hold on the home tab to open the R6X9 settings" defaultsKey:@"settings_shortcut" requiresRestart:YES],
                                                [SCISetting switchCellWithTitle:@"Show tweak settings on app launch" subtitle:@"Automatically opens the R6X9 settings when the app launches" defaultsKey:@"tweak_settings_app_launch"],
        ...
        @{
            @"header": @"Credits",
            @"rows": @[
                [SCISetting linkCellWithTitle:@"Developer" subtitle:@"R6X9" icon:[SCISymbol symbolWithName:@"person.crop.circle.fill" color:[UIColor systemBlueColor] size:20.0] url:@"https://t.me/STORR6X96"],
                [SCISetting linkCellWithTitle:@"Telegram Channel" subtitle:@"t.me/STORR6X96" icon:[SCISymbol symbolWithName:@"paperplane.fill" color:[UIColor systemTealColor] size:20.0] url:@"https://t.me/STORR6X96"],
                [SCISetting linkCellWithTitle:@"Based on SCInsta" subtitle:@"This tweak is built on the open-source SCInsta project" icon:[SCISymbol symbolWithName:@"chevron.left.forwardslash.chevron.right" color:[UIColor systemGrayColor] size:20.0] url:@"https://github.com/SoCuul/SCInsta"]
            ],
            @"footer": [NSString stringWithFormat:@"R6X9 %@\n\nInstagram v%@", SCIVersionString, [SCIUtils IGVersionString]]
        }
    ];
}
